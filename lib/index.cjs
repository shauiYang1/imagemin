...
var name = "unexpected-stream";
var version = "5.1.0";
var description = "node.js streams plugin for the Unexpected assertion library";
var main = "lib/unexpectedStream.js";
...
var author = "Andreas Lind <andreaslindpetersen@gmail.com>";
var license = "BSD-3-Clause";
var bugs = {
	url: "https://github.com/unexpectedjs/unexpected-stream/issues"
};
var homepage = "https://github.com/unexpectedjs/unexpected-stream";
var nyc = {
	include: [
		"lib/**"
	]
...
var unexpectedStream$1 = /*@__PURE__*/getDefaultExportFromCjs(unexpectedStream);
...
const expect = unexpected.clone().use(unexpectedStream$1).use(unexpectedSinon);
      ...
      for (const key in bundler) {
        if (filter(key)) {
          ...
          if (isSVGFile(buffer)) {
            ...
            try {
              const { data } = svgo.optimize(buffer);
